...
/**
 * The PortfolioReport class brings in the Portfolio data (in this case from the
 * SQL database) and prints out the relevant information. In the process of
 * printing, it calls several methods that calculate various important
 * information for the Portfolio such as Commission, Weighted Risk, Fees, and
 * Totals.
 */
